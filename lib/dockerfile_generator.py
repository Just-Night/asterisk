...
class DockerfileGenerator:
    ...
    def prepare_build_context(self, config: Dict[str, Any]) -> BuildContext:
        ...
        try:
            ...
            if yaml_menuselect and any(yaml_menuselect.get(k) for k in ['options', 'enable_categories', 'apps', 'channels', 'drivers', 'enable_apps', 'enable_channels', 'enable_resources']):
