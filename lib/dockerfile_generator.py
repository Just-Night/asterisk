...
class DockerfileGenerator:
    ...
    def _convert_yaml_menuselect_to_commands(self, menuselect_config: Dict[str, Any]) -> List[str]:
        ...
        commands.append("menuselect/menuselect --enable MENUSELECT_CORE_SOUNDS menuselect.makeopts")
        commands.append("menuselect/menuselect --enable MENUSELECT_MOH menuselect.makeopts")
        commands.append("menuselect/menuselect --enable MENUSELECT_EXTRA_SOUNDS menuselect.makeopts")
